...
var import_HeaderSearch_svelte_svelte_type_style_lang_c0700dd8 = require("./HeaderSearch.svelte_svelte_type_style_lang-c0700dd8.js");
var import_flatpickr = require("flatpickr");
var import_mapstore = require("../entries/endpoints/draw/mapstore.js");
const Close16 = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const Close20 = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const Search16 = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const SearchSkeleton = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  let $$restProps = (0, import_index_f909a211.j)($$props, ["small", "size"]);
  ...
  if ($$props.size === void 0 && $$bindings.size && size !== void 0)
    $$bindings.size(size);
  return `
<div${(0, import_index_f909a211.k)([(0, import_index_f909a211.o)($$restProps)], {
    classes: "bx--skeleton " + (size === "sm" || small ? "bx--search--sm" : "") + " " + (size === "lg" ? "bx--search--lg" : "") + " " + (size === "xl" ? "bx--search--xl" : "")
  })}><span${(0, import_index_f909a211.p)("bx--label".trim())}></span>
  <div${(0, import_index_f909a211.p)("bx--search-input".trim())}></div></div>`;
});
const Search = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `${skeleton ? `${(0, import_index_f909a211.v)(SearchSkeleton, "SearchSkeleton").$$render($$result, Object.assign({ small }, { size }, $$restProps), {}, {})}` : `<div role="${"search"}" aria-labelledby="${(0, import_index_f909a211.e)(id) + "-search"}" class="${[
    (0, import_index_f909a211.e)(searchClass),
  ...
  ].join(" ").trim()}"><div${(0, import_index_f909a211.p)("bx--search-magnifier".trim())}${(0, import_index_f909a211.h)("this", searchRef, 0)}>${(0, import_index_f909a211.v)(icon || import_index_f909a211.m, "svelte:component").$$render($$result, { class: "bx--search-magnifier-icon" }, {}, {})}</div>
    <label id="${(0, import_index_f909a211.e)(id) + "-search"}"${(0, import_index_f909a211.h)("for", id, 0)}${(0, import_index_f909a211.p)("bx--label".trim())}>${slots.labelText ? slots.labelText({}) : `
        ${(0, import_index_f909a211.e)(labelText)}
      `}</label>
    
    <input${(0, import_index_f909a211.k)([
    { type: "text" },
    { role: "searchbox" },
    {
    ...
    {
      autocomplete: (0, import_index_f909a211.l)(autocomplete)
    },
    { disabled: disabled || null },
    { id: (0, import_index_f909a211.l)(id) },
    {
      placeholder: (0, import_index_f909a211.l)(placeholder)
    },
    (0, import_index_f909a211.o)($$restProps)
  ], { classes: "bx--search-input" })}${(0, import_index_f909a211.h)("this", ref, 0)}${(0, import_index_f909a211.h)("value", value, 0)}>
    <button type="${"button"}"${(0, import_index_f909a211.h)("aria-label", closeButtonLabelText, 0)} ${disabled ? "disabled" : ""}${(0, import_index_f909a211.p)(("bx--search-close " + (value === "" ? "bx--search-close--hidden" : "")).trim())}>${(0, import_index_f909a211.v)((size === "xl" ? Close20 : Close16) || import_index_f909a211.m, "svelte:component").$$render($$result, {}, {}, {})}</button></div>`}`;
});
const PostcodeSearch = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<main>${(0, import_index_f909a211.v)(Search, "Search").$$render($$result, {
