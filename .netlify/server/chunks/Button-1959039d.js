...
const ButtonSkeleton = (0, import_index_092899d0.c)(($$result, $$props, $$bindings, slots) => {
  let $$restProps = (0, import_index_092899d0.b)($$props, ["href", "size", "small"]);
  ...
  return `
${href ? `<a${(0, import_index_092899d0.d)([
  ...
  })}>${(0, import_index_092899d0.h)("")}</a>` : `<div${(0, import_index_092899d0.d)([(0, import_index_092899d0.e)($$restProps)], {
    classes: "bx--skeleton bx--btn " + (size === "field" ? "bx--btn--field" : "") + " " + (size === "small" || small ? "bx--btn--sm" : "") + " " + (size === "lg" ? "bx--btn--lg" : "") + " " + (size === "xl" ? "bx--btn--xl" : "")
  })}></div>`}`;
});
const Button = (0, import_index_092899d0.c)(($$result, $$props, $$bindings, slots) => {
  let buttonProps;
  ...
  let { ref = null } = $$props;
  const ctx = (0, import_index_092899d0.i)("ComposedModal");
  ...
  return `
${skeleton ? `${(0, import_index_092899d0.v)(ButtonSkeleton, "ButtonSkeleton").$$render($$result, Object.assign({ href }, { size }, $$restProps, { style: hasIconOnly && "width: 3rem;" }), {}, {})}` : `${as ? `${slots.default ? slots.default({ props: buttonProps }) : ``}` : `${href && !disabled ? `
  <a${(0, import_index_092899d0.d)([(0, import_index_092899d0.e)(buttonProps)], {})}${(0, import_index_092899d0.j)("this", ref, 0)}>${hasIconOnly ? `<span${(0, import_index_092899d0.k)("bx--assistive-text".trim())}>${(0, import_index_092899d0.h)(iconDescription)}</span>` : ``}
    ${slots.default ? slots.default({}) : ``}${(0, import_index_092899d0.v)(icon || import_index_092899d0.m, "svelte:component").$$render($$result, {
    "aria-hidden": "true",
    class: "bx--btn__icon",
    "aria-label": iconDescription
  }, {}, {})}</a>` : `<button${(0, import_index_092899d0.d)([(0, import_index_092899d0.e)(buttonProps)], {})}${(0, import_index_092899d0.j)("this", ref, 0)}>${hasIconOnly ? `<span${(0, import_index_092899d0.k)("bx--assistive-text".trim())}>${(0, import_index_092899d0.h)(iconDescription)}</span>` : ``}
    ${slots.default ? slots.default({}) : ``}${(0, import_index_092899d0.v)(icon || import_index_092899d0.m, "svelte:component").$$render($$result, {
    "aria-hidden": "true",
    class: "bx--btn__icon",
    "aria-label": iconDescription
