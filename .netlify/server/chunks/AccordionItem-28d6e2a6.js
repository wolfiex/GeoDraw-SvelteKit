...
const ChevronRight16 = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const AccordionItem = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  let $$restProps = (0, import_index_12fa369c.b)($$props, ["title", "open", "disabled", "iconDescription"]);
  let { title = "title" } = $$props;
  let { open = false } = $$props;
  let { disabled = false } = $$props;
  let { iconDescription = "Expand/Collapse" } = $$props;
  let initialDisabled = disabled;
  const ctx = (0, import_index_12fa369c.i)("Accordion");
...
<li${(0, import_index_12fa369c.d)([(0, import_index_12fa369c.e)($$restProps)], {
  ...
  })}><button type="${"button"}"${(0, import_index_12fa369c.j)("title", iconDescription, 0)}${(0, import_index_12fa369c.j)("aria-expanded", open, 0)} ${disabled ? "disabled" : ""}${(0, import_index_12fa369c.k)("bx--accordion__heading".trim())}>${(0, import_index_12fa369c.v)(ChevronRight16, "ChevronRight16").$$render($$result, {
    class: "bx--accordion__arrow",
    "aria-label": iconDescription
  }, {}, {})}
    <div${(0, import_index_12fa369c.k)("bx--accordion__title".trim())}>${slots.title ? slots.title({}) : `${(0, import_index_12fa369c.h)(title)}`}</div></button>
  <div${(0, import_index_12fa369c.k)("bx--accordion__content".trim())}>${slots.default ? slots.default({}) : ``}</div></li>`;
});
