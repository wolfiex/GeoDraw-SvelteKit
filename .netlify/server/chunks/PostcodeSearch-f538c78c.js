...
const Close20 = (0, import_index_092899d0.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const Search16 = (0, import_index_092899d0.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const SearchSkeleton = (0, import_index_092899d0.c)(($$result, $$props, $$bindings, slots) => {
  let $$restProps = (0, import_index_092899d0.b)($$props, ["small", "size"]);
...
<div${(0, import_index_092899d0.d)([(0, import_index_092899d0.e)($$restProps)], {
  ...
  })}><span${(0, import_index_092899d0.k)("bx--label".trim())}></span>
  <div${(0, import_index_092899d0.k)("bx--search-input".trim())}></div></div>`;
});
const Search = (0, import_index_092899d0.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `${skeleton ? `${(0, import_index_092899d0.v)(SearchSkeleton, "SearchSkeleton").$$render($$result, Object.assign({ small }, { size }, $$restProps), {}, {})}` : `<div role="${"search"}" aria-labelledby="${(0, import_index_092899d0.h)(id) + "-search"}" class="${[
    (0, import_index_092899d0.h)(searchClass),
  ...
  ].join(" ").trim()}"><div${(0, import_index_092899d0.k)("bx--search-magnifier".trim())}${(0, import_index_092899d0.j)("this", searchRef, 0)}>${(0, import_index_092899d0.v)(icon || import_index_092899d0.m, "svelte:component").$$render($$result, { class: "bx--search-magnifier-icon" }, {}, {})}</div>
    <label id="${(0, import_index_092899d0.h)(id) + "-search"}"${(0, import_index_092899d0.j)("for", id, 0)}${(0, import_index_092899d0.k)("bx--label".trim())}>${slots.labelText ? slots.labelText({}) : `
        ${(0, import_index_092899d0.h)(labelText)}
      `}</label>
    
    <input${(0, import_index_092899d0.d)([
    { type: "text" },
    { role: "searchbox" },
    {
    ...
    {
      autocomplete: (0, import_index_092899d0.f)(autocomplete)
    },
    { disabled: disabled || null },
    { id: (0, import_index_092899d0.f)(id) },
    {
      placeholder: (0, import_index_092899d0.f)(placeholder)
    },
    (0, import_index_092899d0.e)($$restProps)
  ], { classes: "bx--search-input" })}${(0, import_index_092899d0.j)("this", ref, 0)}${(0, import_index_092899d0.j)("value", value, 0)}>
    <button type="${"button"}"${(0, import_index_092899d0.j)("aria-label", closeButtonLabelText, 0)} ${disabled ? "disabled" : ""}${(0, import_index_092899d0.k)(("bx--search-close " + (value === "" ? "bx--search-close--hidden" : "")).trim())}>${(0, import_index_092899d0.v)((size === "xl" ? Close20 : Close16) || import_index_092899d0.m, "svelte:component").$$render($$result, {}, {}, {})}</button></div>`}`;
});
const PostcodeSearch = (0, import_index_092899d0.c)(($$result, $$props, $$bindings, slots) => {
  let $mapobject, $$unsubscribe_mapobject;
  $$unsubscribe_mapobject = (0, import_index_092899d0.o)(import_mapstore.mapobject, (value) => $mapobject = value);
  $$unsubscribe_mapobject();
  return `<main><div>${(0, import_index_092899d0.v)(import_Column_3c16437e.R, "Row").$$render($$result, {}, {}, {
    default: () => {
      return `${(0, import_index_092899d0.v)(Search, "Search").$$render($$result, {
