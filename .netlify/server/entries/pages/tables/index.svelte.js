...
const Card = (0, import_index_e390a0ae.c)(($$result, $$props, $$bindings, slots) => {
  ...
  const { cols } = (0, import_index_e390a0ae.d)("tiles");
  $$unsubscribe_cols = (0, import_index_e390a0ae.b)(cols, (value) => $cols = value);
  ...
  return `<article class="${[
    (0, import_index_e390a0ae.e)((0, import_index_e390a0ae.k)(!blank ? "tile tile__content" : "")) + " svelte-1krn9ab",
    blank ? "blank" : ""
  ].join(" ").trim()}"${(0, import_index_e390a0ae.f)({
    "grid-column": `span ${colspan == 1 ? 1 : colspan > $cols ? $cols : colspan}`,
    "grid-row": `span ${rowspan}`
  })}>${title ? `<header class="${"margin-top--1"}"><h3 class="${"margin-top--0 margin-right--0 margin-bottom--0 margin-left--0 svelte-1krn9ab"}">${(0, import_index_e390a0ae.e)(title)}</h3></header>` : ``}
  ${slots.default ? slots.default({}) : ``}
  ${links && links[0] ? `<div class="${"margin-top--2"}">${(0, import_index_e390a0ae.i)(links, (link) => {
    return `<a${(0, import_index_e390a0ae.h)("href", link.url, 0)} class="${"tile__link"}"${(0, import_index_e390a0ae.h)("aria-label", link.label, 0)}${(0, import_index_e390a0ae.h)("data-gtm-label", link.label, 0)}>${(0, import_index_e390a0ae.e)(link.label)}
    </a>`;
  })}</div>` : ``}
</article>`;
});
...
const Tables = (0, import_index_e390a0ae.c)(($$result, $$props, $$bindings, slots) => {
  let cache = {};
  let areas = "";
  var newdata = { tables: [] };
  var coordinates = [];
  ...
  return `${(0, import_index_e390a0ae.v)(import_LibLoader_svelte.default, "LibLoader").$$render($$result, {
...
<h1 class="${"svelte-nzgl4g"}">${(0, import_index_e390a0ae.e)(name)}</h1>
${(0, import_index_e390a0ae.v)(Cards, "Cards").$$render($$result, {}, {}, {
    default: () => {
      return `${(0, import_index_e390a0ae.v)(Card, "Card").$$render($$result, { title: "Area map" }, {}, {
        default: () => {
          return `${(0, import_index_e390a0ae.v)(import_MapAreas_svelte.default, "MapAreas").$$render($$result, { minimap: coordinates }, {}, {})}`;
        }
      })}

  ${(0, import_index_e390a0ae.v)(Card, "Card").$$render($$result, { title: "Selected Areas" }, {}, {
        default: () => {
          return `This section outlines all the different areas codes which have been combined
    to produce the following report.
    <br><br>
    ${(0, import_index_e390a0ae.i)(items(compressed), (item) => {
            return `<h4 style="${"display:inline"}"><b class="${"svelte-nzgl4g"}">${(0, import_index_e390a0ae.e)(item[0].toUpperCase())}</b>:</h4>
      <codes class="${"svelte-nzgl4g"}">${(0, import_index_e390a0ae.e)(item[1].join(", "))}</codes>
      <br><br>`;
          })}`;
        }
      })}
  ...
  ${(0, import_index_e390a0ae.v)(Card, "Card").$$render($$result, { title: "Embed Url" }, {}, {
            default: () => {
              return `<code>Click here to copy the embed url to your clipboard: <br>
      ${(0, import_index_e390a0ae.e)(JSON.stringify(tables).length)}</code>`;
            }
          })}
    ${(0, import_index_e390a0ae.i)(tables, (tab) => {
            return `${(0, import_index_e390a0ae.v)(Card, "Card").$$render($$result, { title: tab.name }, {}, {
              default: () => {
                return `

        ${(0, import_index_e390a0ae.v)(import_BarChart_svelte.default, "BarChart").$$render($$result, {
                  xKey: "pc",
                  yKey: "column",
                  zKey: "z",
                  data: tab.data
