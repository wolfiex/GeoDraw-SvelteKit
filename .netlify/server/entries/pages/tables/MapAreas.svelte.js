...
const MapAreas = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<main><div id="${"lmap"}" style="${"height:" + (0, import_index_f909a211.e)(height) + "; width:100%"}" class="${"svelte-hs5vhq"}"></div></main>`;
});
