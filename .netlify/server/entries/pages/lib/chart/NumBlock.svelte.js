...
const NumBlock = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  let { data } = $$props;
  let { suffix = "" } = $$props;
  ...
  $$result.css.add(css);
  return `<div class="${"num-big svelte-19zwnt3"}">${(0, import_index_f909a211.e)(format(data[0][xKey]))}</div>
<div class="${"num-suffix svelte-19zwnt3"}">${(0, import_index_f909a211.e)(suffix)}</div>
<div class="${"num-desc svelte-19zwnt3"}"><mark class="${"svelte-19zwnt3"}">${(0, import_index_f909a211.e)(format(data[1][xKey]))}</mark> 
  for ${(0, import_index_f909a211.e)(data[1][zKey])}
</div>`;
});
