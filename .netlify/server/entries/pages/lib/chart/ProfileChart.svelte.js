...
const ProfileChart = (0, import_index_e390a0ae.c)(($$result, $$props, $$bindings, slots) => {
  let xDomain;
  let yDomain;
  let zDomain;
  let yScale;
  ...
  return `<ul class="${"legend-block svelte-vf344q"}">${zDomain[1] ? `${(0, import_index_e390a0ae.i)(zDomain, (group, i) => {
    return `<li class="${"svelte-vf344q"}"><div class="${"legend-vis " + (0, import_index_e390a0ae.e)(i == 0 ? "bar" : "marker-vis") + " svelte-vf344q"}"${(0, import_index_e390a0ae.f)({
      "border-bottom-width": `${i == 0 ? 0 : markerWidth}px`
    })}></div>
		<span class="${(0, import_index_e390a0ae.e)((0, import_index_e390a0ae.k)(i == 0 ? "bold" : "brackets")) + " svelte-vf344q"}">${(0, import_index_e390a0ae.e)(group)}</span>
	</li>`;
  })}` : ``}</ul>

<div class="${"bar-group svelte-vf344q"}"${(0, import_index_e390a0ae.f)({ "height": `${height}px` })}>${(0, import_index_e390a0ae.i)(data_stacked, (stack, i) => {
    return `${i == 0 ? `${(0, import_index_e390a0ae.i)(stack.values, (d, j) => {
      return `<div class="${"bar svelte-vf344q"}"${(0, import_index_e390a0ae.f)({
        "top": `${100 - yScale(d[yKey])}%`,
        "height": `${yScale(d[yKey])}%`,
        "left": `${j / xDomain.length * 100}%`,
        "width": `calc(${1 / xDomain.length * 100}% + 0.2px)`
      })}></div>`;
    })}` : `${(0, import_index_e390a0ae.i)(stack.values, (d, j) => {
      return `<div class="${"marker svelte-vf344q"}"${(0, import_index_e390a0ae.f)({
...
<div class="${"x-scale svelte-vf344q"}"${(0, import_index_e390a0ae.f)({ "height": `1rem` })}><div class="${"svelte-vf344q"}"${(0, import_index_e390a0ae.f)({ "left": 0 })}>${(0, import_index_e390a0ae.e)(minmax[0])}</div>
	<div class="${"svelte-vf344q"}"${(0, import_index_e390a0ae.f)({ "right": 0 })}>${(0, import_index_e390a0ae.e)(minmax[1])}</div>
</div>`;
});
