...
const ProfileChart = (0, import_index_0029e4b6.c)(($$result, $$props, $$bindings, slots) => {
  let xDomain;
  let yDomain;
  let zDomain;
  let yScale;
  ...
  return `<ul class="${"legend-block svelte-vf344q"}">${zDomain[1] ? `${(0, import_index_0029e4b6.j)(zDomain, (group, i) => {
    return `<li class="${"svelte-vf344q"}"><div class="${"legend-vis " + (0, import_index_0029e4b6.f)(i == 0 ? "bar" : "marker-vis") + " svelte-vf344q"}"${(0, import_index_0029e4b6.e)({
      "border-bottom-width": `${i == 0 ? 0 : markerWidth}px`
    })}></div>
		<span class="${(0, import_index_0029e4b6.f)((0, import_index_0029e4b6.k)(i == 0 ? "bold" : "brackets")) + " svelte-vf344q"}">${(0, import_index_0029e4b6.f)(group)}</span>
	</li>`;
  })}` : ``}</ul>

<div class="${"bar-group svelte-vf344q"}"${(0, import_index_0029e4b6.e)({ "height": `${height}px` })}>${(0, import_index_0029e4b6.j)(data_stacked, (stack, i) => {
    return `${i == 0 ? `${(0, import_index_0029e4b6.j)(stack.values, (d, j) => {
      return `<div class="${"bar svelte-vf344q"}"${(0, import_index_0029e4b6.e)({
        "top": `${100 - yScale(d[yKey])}%`,
        "height": `${yScale(d[yKey])}%`,
        "left": `${j / xDomain.length * 100}%`,
        "width": `calc(${1 / xDomain.length * 100}% + 0.2px)`
      })}></div>`;
    })}` : `${(0, import_index_0029e4b6.j)(stack.values, (d, j) => {
      return `<div class="${"marker svelte-vf344q"}"${(0, import_index_0029e4b6.e)({
...
<div class="${"x-scale svelte-vf344q"}"${(0, import_index_0029e4b6.e)({ "height": `1rem` })}><div class="${"svelte-vf344q"}"${(0, import_index_0029e4b6.e)({ "left": 0 })}>${(0, import_index_0029e4b6.f)(minmax[0])}</div>
	<div class="${"svelte-vf344q"}"${(0, import_index_0029e4b6.e)({ "right": 0 })}>${(0, import_index_0029e4b6.f)(minmax[1])}</div>
</div>`;
});
