...
${(0, import_index_f909a211.i)(data_grouped, (group) => {
    return `<div class="${"label-group svelte-1ri9pb8"}">${(0, import_index_f909a211.e)(group.label)}
      ...
      return `<span class="${"label " + (0, import_index_f909a211.e)(i == 0 ? "bold" : "sml brackets") + " svelte-1ri9pb8"}">${(0, import_index_f909a211.e)(format(d.value))}${(0, import_index_f909a211.e)(suffix)}</span>`;
    })}</div>
