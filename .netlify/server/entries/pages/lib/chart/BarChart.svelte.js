...
${(0, import_index_12fa369c.r)(data_grouped, (group) => {
    return `<div class="${"label-group svelte-1ri9pb8"}">${(0, import_index_12fa369c.h)(group.label)}
      ...
      return `<span class="${"label " + (0, import_index_12fa369c.h)(i == 0 ? "bold" : "sml brackets") + " svelte-1ri9pb8"}">${(0, import_index_12fa369c.h)(format(d.value))}${(0, import_index_12fa369c.h)(suffix)}</span>`;
    })}</div>
