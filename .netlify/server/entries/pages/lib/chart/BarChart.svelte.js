...
${(0, import_index_e390a0ae.i)(data_grouped, (group) => {
    return `<div class="${"label-group svelte-1ri9pb8"}">${(0, import_index_e390a0ae.e)(group.label)}
      ...
      return `<span class="${"label " + (0, import_index_e390a0ae.e)(i == 0 ? "bold" : "sml brackets") + " svelte-1ri9pb8"}">${(0, import_index_e390a0ae.e)(format(d.value))}${(0, import_index_e390a0ae.e)(suffix)}</span>`;
    })}</div>
