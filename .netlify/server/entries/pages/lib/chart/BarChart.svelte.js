...
${(0, import_index_c9602e46.i)(data_grouped, (group) => {
    return `<div class="${"label-group svelte-1ri9pb8"}">${(0, import_index_c9602e46.e)(group.label)}
      ...
      return `<span class="${"label " + (0, import_index_c9602e46.e)(i == 0 ? "bold" : "sml brackets") + " svelte-1ri9pb8"}">${(0, import_index_c9602e46.e)(format(d.value))}${(0, import_index_c9602e46.e)(suffix)}</span>`;
    })}</div>
