...
const Titleblock = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  ...
  let { hr = true } = $$props;
  (0, import_index_12fa369c.s)("mode", mode);
  (0, import_index_12fa369c.s)("background", background);
  ...
  if ($$props.hr === void 0 && $$bindings.hr && hr !== void 0)
    $$bindings.hr(hr);
  return `<div class="${"page-neutral-intro " + (0, import_index_12fa369c.h)(background == "grey" ? "background--gallery" : "")}"><div class="${"wrapper"}"><div class="${"col-wrap"}"><div class="${"col"}">${breadcrumb ? `${(0, import_index_12fa369c.v)(import_Breadcrumb_svelte.default, "Breadcrumb").$$render($$result, {
    links: breadcrumb,
    ...
    (highlighted ? "col--lg-38" : "") + " " + (!highlighted ? "col--lg-48" : "")
					...
					${date ? `<p class="${"page-neutral-intro__meta margin-top--0 margin-bottom--3"}">${(0, import_index_12fa369c.h)(date)}</p>` : ``}
					${contents ? `${(0, import_index_12fa369c.v)(import_Navbox_svelte.default, "Navbox").$$render($$result, { links: contents, title: "Contents" }, {}, {})}` : ``}</div>
				${highlighted ? `${(0, import_index_12fa369c.v)(import_Highlighted_svelte.default, "Highlighted").$$render($$result, { links: highlighted }, {}, {})}` : ``}</div></div></div>
	${slots.meta ? slots.meta({}) : ``}
	${updated ? `${(0, import_index_12fa369c.v)(import_Meta_svelte.default, "Meta").$$render($$result, {
    label: "Last updated",
    value: updated,
    background
  }, {}, {})}` : ``}
