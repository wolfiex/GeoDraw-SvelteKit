...
const Figure = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
...
<div class="${"actions svelte-144diyl"}">${embed ? `<button aria-label="${"embed code"}"${(0, import_index_12fa369c.j)("aria-expanded", expanded, 0)} class="${"svelte-144diyl"}">Embed code</button>` : ``}
