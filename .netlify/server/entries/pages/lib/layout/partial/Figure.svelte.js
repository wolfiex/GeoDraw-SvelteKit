...
const Figure = (0, import_index_c9602e46.c)(($$result, $$props, $$bindings, slots) => {
...
<div class="${"actions svelte-144diyl"}">${embed ? `<button aria-label="${"embed code"}"${(0, import_index_c9602e46.h)("aria-expanded", expanded, 0)} class="${"svelte-144diyl"}">Embed code</button>` : ``}
