...
const CardSection = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<article class="${[
    ...
    "background--gallery  "
  ].join(" ").trim()}"><h3 class="${"flush"}"><a${(0, import_index_f909a211.h)("href", url, 0)}>${(0, import_index_f909a211.e)(title)}
  ...
  ].join(" ").trim()}"><p class="${"svelte-lpcnsk"}">${(0, import_index_f909a211.e)(description)}</p></div>` : `<div class="${[
    "js-hover-click height--31 print--hide",
    "background--mercury "
  ].join(" ").trim()}"><div class="${"box__image padding-top--16 padding-right--1 padding-left--1"}"><h3 class="${"flush"}"><a${(0, import_index_f909a211.h)("href", url, 0)}>${(0, import_index_f909a211.e)(title)}
          <span class="${"image-holder height--14"}"><img${(0, import_index_f909a211.h)("src", image, 0)}${(0, import_index_f909a211.h)("alt", title, 0)} class="${"no-border"}"></span>
          <span class="${"box__clickable"}"></span></a></h3>
      <p class="${"box__content flush svelte-lpcnsk"}">${(0, import_index_f909a211.e)(description)}</p></div></div>`}
</article>`;
});
