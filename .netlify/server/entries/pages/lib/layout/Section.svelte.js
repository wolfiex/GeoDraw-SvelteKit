...
const Section = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.id === void 0 && $$bindings.id && id !== void 0)
    $$bindings.id(id);
  return `<div${(0, import_index_12fa369c.j)("id", id, 0)} class="${"section__content--markdown section__content--markdown--neutral-article"}"><section>${slots.default ? slots.default({}) : ``}
