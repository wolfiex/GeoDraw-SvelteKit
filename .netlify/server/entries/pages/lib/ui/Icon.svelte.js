...
const Icon = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.name === void 0 && $$bindings.name && name !== void 0)
    $$bindings.name(name);
  $$result.css.add(css);
  return `<svg viewBox="${"0 0 24 24"}" fill-rule="${"evenodd"}" clip-rule="${"evenodd"}" class="${"svelte-1ior0zp"}"><path${(0, import_index_12fa369c.j)("d", paths[name], 0)}></path></svg>`;
});
