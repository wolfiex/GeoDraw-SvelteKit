...
const Toggle = (0, import_index_0029e4b6.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<div class="${"switch svelte-g1x8yy"}"><input${(0, import_index_0029e4b6.i)("id", id, 0)} type="${"checkbox"}" class="${"switch-input svelte-g1x8yy"}" tabindex="${"0"}"${(0, import_index_0029e4b6.i)("checked", checked, 1)}>
  <label${(0, import_index_0029e4b6.i)("for", id, 0)} class="${["switch-label svelte-g1x8yy", mono ? "mono" : ""].join(" ").trim()}">${(0, import_index_0029e4b6.f)(label)}</label>
</div>`;
});
