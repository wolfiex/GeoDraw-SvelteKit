...
const Toggle = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  let { id = "switch" } = $$props;
  ...
  $$result.css.add(css);
  return `<div class="${"switch svelte-g1x8yy"}"><input${(0, import_index_12fa369c.j)("id", id, 0)} type="${"checkbox"}" class="${"switch-input svelte-g1x8yy"}" tabindex="${"0"}"${(0, import_index_12fa369c.j)("checked", checked, 1)}>
  <label${(0, import_index_12fa369c.j)("for", id, 0)} class="${["switch-label svelte-g1x8yy", mono ? "mono" : ""].join(" ").trim()}">${(0, import_index_12fa369c.h)(label)}</label>
</div>`;
});
