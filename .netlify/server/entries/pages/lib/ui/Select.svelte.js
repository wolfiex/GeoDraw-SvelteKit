...
const Select = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  let regex;
...
<div id="${"select"}" class="${["svelte-10s1oab", ""].join(" ").trim()}">${selectedItem && !search ? `<a id="${"toggle"}" class="${"selected svelte-10s1oab"}"><span class="${"selection svelte-10s1oab"}">${(0, import_index_f909a211.e)(selectedItem[label])} ${group ? `<small class="${"svelte-10s1oab"}">${(0, import_index_f909a211.e)(selectedItem[group])}</small>` : ``}</span>
		<span class="${"button close svelte-10s1oab"}">\xA0</span></a>` : `<a id="${"toggle"}" class="${"svelte-10s1oab"}"><span class="${"svelte-10s1oab"}">${(0, import_index_f909a211.e)(placeholder ? placeholder : "Select one")}</span>
		<span class="${[
