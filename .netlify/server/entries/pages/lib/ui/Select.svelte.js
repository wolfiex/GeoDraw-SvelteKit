...
<div id="${"select"}" class="${["svelte-10s1oab", ""].join(" ").trim()}">${selectedItem && !search ? `<a id="${"toggle"}" class="${"selected svelte-10s1oab"}"><span class="${"selection svelte-10s1oab"}">${(0, import_index_0029e4b6.f)(selectedItem[label])} ${group ? `<small class="${"svelte-10s1oab"}">${(0, import_index_0029e4b6.f)(selectedItem[group])}</small>` : ``}</span>
		<span class="${"button close svelte-10s1oab"}">\xA0</span></a>` : `<a id="${"toggle"}" class="${"svelte-10s1oab"}"><span class="${"svelte-10s1oab"}">${(0, import_index_0029e4b6.f)(placeholder ? placeholder : "Select one")}</span>
		<span class="${[
