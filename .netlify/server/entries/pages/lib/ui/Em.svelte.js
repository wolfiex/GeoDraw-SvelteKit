...
const Em = (0, import_index_0029e4b6.c)(($$result, $$props, $$bindings, slots) => {
  let rgb;
  ...
  return `<span class="${["em svelte-s1t2y4", nowrap ? "nowrap" : ""].join(" ").trim()}" style="${"background-color: " + (0, import_index_0029e4b6.f)(color) + "; color: " + (0, import_index_0029e4b6.f)(text) + ";"}" role="${"presentation"}">${slots.default ? slots.default({}) : ``}
</span>`;
});
