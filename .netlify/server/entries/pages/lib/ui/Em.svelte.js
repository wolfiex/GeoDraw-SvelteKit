...
const Em = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  let rgb;
  ...
  return `<span class="${["em svelte-s1t2y4", nowrap ? "nowrap" : ""].join(" ").trim()}" style="${"background-color: " + (0, import_index_f909a211.e)(color) + "; color: " + (0, import_index_f909a211.e)(text) + ";"}" role="${"presentation"}">${slots.default ? slots.default({}) : ``}
</span>`;
});
