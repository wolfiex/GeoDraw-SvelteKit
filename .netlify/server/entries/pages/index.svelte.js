...
const Routes = (0, import_index_e390a0ae.c)(($$result, $$props, $$bindings, slots) => {
  return `<br><br>
${(0, import_index_e390a0ae.v)(import_Button_b480e50a.B, "Button").$$render($$result, { href: "/draw" + drawhash }, {}, {
    default: () => {
      return `draw`;
    }
  })}
${(0, import_index_e390a0ae.v)(import_Button_b480e50a.B, "Button").$$render($$result, { kind: "secondary", href: "/build" + hash }, {}, {
    default: () => {
      return `build`;
    }
  })}`;
