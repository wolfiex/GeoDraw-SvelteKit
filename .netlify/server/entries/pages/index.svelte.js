...
const Routes = (0, import_index_c9602e46.c)(($$result, $$props, $$bindings, slots) => {
  return `<br><br>
${(0, import_index_c9602e46.v)(import_Button_39f7a3af.B, "Button").$$render($$result, { href: "/draw" + drawhash }, {}, {
    default: () => {
      return `draw`;
    }
  })}
${(0, import_index_c9602e46.v)(import_Button_39f7a3af.B, "Button").$$render($$result, { kind: "secondary", href: "/build" + hash }, {}, {
    default: () => {
      return `build`;
    }
  })}`;
