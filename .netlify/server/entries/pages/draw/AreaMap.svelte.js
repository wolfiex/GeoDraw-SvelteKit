...
/* purgecss end ignore */`)();
var AreaMap_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => "/* purgecss start ignore */\n\nmain.svelte-2r8wq7{\n  position:absolute;\n  top:0;\n  left:0;\n  margin:auto\n}\n\n/* purgecss end ignore */")();
const css = {
  code: "main.svelte-2r8wq7{position:absolute;top:0;left:0;margin:auto}",
  map: null
};
const AreaMap = (0, import_index_092899d0.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_mapfunctions = (0, import_index_092899d0.o)(import_mapstore.mapfunctions, (value) => $mapfunctions = value);
  $$unsubscribe_maplayer = (0, import_index_092899d0.o)(import_mapstore.maplayer, (value) => $maplayer = value);
  $$unsubscribe_mapsource = (0, import_index_092899d0.o)(import_mapstore.mapsource, (value) => $mapsource = value);
  ...
  async function SetLayers() {
    ...
    $mapobject.fitBounds(import_mapstore.location.bounds, { padding: 20 });
  ...
  return `
<main class="${"svelte-2r8wq7"}"><div class="${"mapboxgl-canvas"}" tabindex="${"0"}" aria-label="${"Map"}" id="${"mapcontainer"}" style="${"width: " + (0, import_index_092899d0.h)(width) + "; height: " + (0, import_index_092899d0.h)(height) + "; opacity:" + (0, import_index_092899d0.h)(loading ? 0.4 : 1)}"${(0, import_index_092899d0.j)("this", webgl_canvas, 0)}></div>
</main>`;
});
