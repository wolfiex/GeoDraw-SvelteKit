...
var import_Grid_5e1041d9 = require("../../../chunks/Grid-5e1041d9.js");
...
var import_PostcodeSearch_fa081eca = require("../../../chunks/PostcodeSearch-fa081eca.js");
...
const BreadcrumbSkeleton = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  let $$restProps = (0, import_index_12fa369c.b)($$props, ["noTrailingSlash", "count"]);
...
<div${(0, import_index_12fa369c.d)([(0, import_index_12fa369c.e)($$restProps)], {
  ...
  })}>${(0, import_index_12fa369c.r)(Array.from({ length: count }, (_, i) => i), (item) => {
    return `<div${(0, import_index_12fa369c.k)("bx--breadcrumb-item".trim())}><span${(0, import_index_12fa369c.k)("bx--link".trim())}>\xA0</span>
    </div>`;
  })}</div>`;
});
const Breadcrumb = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  let $$restProps = (0, import_index_12fa369c.b)($$props, ["noTrailingSlash", "skeleton"]);
  let { noTrailingSlash = false } = $$props;
  ...
  return `
${skeleton ? `${(0, import_index_12fa369c.v)(BreadcrumbSkeleton, "BreadcrumbSkeleton").$$render($$result, Object.assign({ noTrailingSlash }, $$restProps), {}, {})}` : `<nav${(0, import_index_12fa369c.d)([{ "aria-label": "Breadcrumb" }, (0, import_index_12fa369c.e)($$restProps)], {})}><ol${(0, import_index_12fa369c.k)(("bx--breadcrumb " + (noTrailingSlash ? "bx--breadcrumb--no-trailing-slash" : "")).trim())}>${slots.default ? slots.default({}) : ``}</ol></nav>`}`;
});
const Link = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  let $$restProps = (0, import_index_12fa369c.b)($$props, ["size", "href", "inline", "icon", "disabled", "visited", "ref"]);
  ...
  if ($$props.ref === void 0 && $$bindings.ref && ref !== void 0)
    $$bindings.ref(ref);
  return `
${disabled ? `<p${(0, import_index_12fa369c.d)([(0, import_index_12fa369c.e)($$restProps)], {
    classes: "bx--link " + (disabled ? "bx--link--disabled" : "") + " " + (inline ? "bx--link--inline" : "") + " " + (visited ? "bx--link--visited" : "")
  })}${(0, import_index_12fa369c.j)("this", ref, 0)}>${slots.default ? slots.default({}) : ``}
    ${!inline && ($$slots.icon || icon) ? `<div${(0, import_index_12fa369c.k)("bx--link__icon".trim())}>${slots.icon ? slots.icon({}) : `
          ${(0, import_index_12fa369c.v)(icon || import_index_12fa369c.m, "svelte:component").$$render($$result, {}, {}, {})}
        `}</div>` : ``}</p>` : `<a${(0, import_index_12fa369c.d)([
    {
...
const BreadcrumbItem = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  let $$restProps = (0, import_index_12fa369c.b)($$props, ["href", "isCurrentPage"]);
  let { href = void 0 } = $$props;
  let { isCurrentPage = false } = $$props;
  (0, import_index_12fa369c.s)("BreadcrumbItem", {});
  if ($$props.href === void 0 && $$bindings.href && href !== void 0)
    $$bindings.href(href);
  if ($$props.isCurrentPage === void 0 && $$bindings.isCurrentPage && isCurrentPage !== void 0)
    $$bindings.isCurrentPage(isCurrentPage);
  return `
<li${(0, import_index_12fa369c.d)([(0, import_index_12fa369c.e)($$restProps)], {
    classes: "bx--breadcrumb-item " + (isCurrentPage && $$restProps["aria-current"] !== "page" ? "bx--breadcrumb-item--current" : "")
  })}>${href ? `${(0, import_index_12fa369c.v)(Link, "Link").$$render($$result, {
    href,
...
const NotificationButton = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  let $$restProps = (0, import_index_12fa369c.b)($$props, ["notificationType", "icon", "title", "iconDescription"]);
  let { notificationType = "toast" } = $$props;
  let { icon = import_PostcodeSearch_fa081eca.C } = $$props;
  ...
  return `
<button${(0, import_index_12fa369c.d)([
    { type: "button" },
    {
      "aria-label": (0, import_index_12fa369c.f)(iconDescription)
    },
    {
      title: (0, import_index_12fa369c.f)(iconDescription)
    },
    (0, import_index_12fa369c.e)($$restProps)
  ], {
...
const CheckmarkFilled20 = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const ErrorFilled20 = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const InformationFilled20 = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const InformationSquareFilled20 = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const WarningFilled20 = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const WarningAltFilled20 = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const NotificationIcon = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.iconDescription === void 0 && $$bindings.iconDescription && iconDescription !== void 0)
    $$bindings.iconDescription(iconDescription);
  return `${(0, import_index_12fa369c.v)(icons[kind] || import_index_12fa369c.m, "svelte:component").$$render($$result, {
    title: iconDescription,
    class: "bx--" + notificationType + "-notification__icon"
  }, {}, {})}`;
});
const ToastNotification = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `
${`<div${(0, import_index_12fa369c.d)([
    { role: (0, import_index_12fa369c.f)(role) },
    { kind: (0, import_index_12fa369c.f)(kind) },
    (0, import_index_12fa369c.e)($$restProps)
  ], {
  ...
  })}>${(0, import_index_12fa369c.v)(NotificationIcon, "NotificationIcon").$$render($$result, { kind }, {}, {})}
    <div${(0, import_index_12fa369c.k)("bx--toast-notification__details".trim())}><h3${(0, import_index_12fa369c.k)("bx--toast-notification__title".trim())}>${slots.title ? slots.title({}) : `${(0, import_index_12fa369c.h)(title)}`}</h3>
      <div${(0, import_index_12fa369c.k)("bx--toast-notification__subtitle".trim())}>${slots.subtitle ? slots.subtitle({}) : `${(0, import_index_12fa369c.h)(subtitle)}`}</div>
      <div${(0, import_index_12fa369c.k)("bx--toast-notification__caption".trim())}>${slots.caption ? slots.caption({}) : `${(0, import_index_12fa369c.h)(caption)}`}</div>
      ${slots.default ? slots.default({}) : ``}</div>
    ${!hideCloseButton ? `${(0, import_index_12fa369c.v)(NotificationButton, "NotificationButton").$$render($$result, { iconDescription }, {}, {})}` : ``}</div>`}`;
});
const Slider = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  let labelId;
  let range;
  let left;
  let $$restProps = (0, import_index_12fa369c.b)($$props, [
...
<div${(0, import_index_12fa369c.d)([(0, import_index_12fa369c.e)($$restProps)], { classes: "bx--form-item" })}><label${(0, import_index_12fa369c.j)("for", id, 0)}${(0, import_index_12fa369c.j)("id", labelId, 0)}${(0, import_index_12fa369c.k)(("bx--label " + (disabled ? "bx--label--disabled" : "")).trim())}>${slots.labelText ? slots.labelText({}) : `
      ${(0, import_index_12fa369c.h)(labelText)}
    `}</label>
  <div${(0, import_index_12fa369c.k)("bx--slider-container".trim())}><span${(0, import_index_12fa369c.k)("bx--slider__range-label".trim())}>${(0, import_index_12fa369c.h)(minLabel || min)}</span>
    <div role="${"presentation"}" tabindex="${"-1"}"${(0, import_index_12fa369c.k)(("bx--slider " + (disabled ? "bx--slider--disabled" : "")).trim())}${(0, import_index_12fa369c.j)("this", ref, 0)}><div role="${"slider"}" tabindex="${"0"}" style="${"left: " + (0, import_index_12fa369c.h)(left) + "%"}"${(0, import_index_12fa369c.j)("aria-valuemax", max, 0)}${(0, import_index_12fa369c.j)("aria-valuemin", min, 0)}${(0, import_index_12fa369c.j)("aria-valuenow", value, 0)}${(0, import_index_12fa369c.j)("id", id, 0)}${(0, import_index_12fa369c.k)("bx--slider__thumb".trim())}></div>
      <div${(0, import_index_12fa369c.k)("bx--slider__track".trim())}${(0, import_index_12fa369c.j)("this", trackRef, 0)}></div>
      <div style="${"transform: translate(0, -50%) scaleX(" + (0, import_index_12fa369c.h)(left / 100) + ")"}"${(0, import_index_12fa369c.k)("bx--slider__filled-track".trim())}></div>
      <input type="${"hidden"}"${(0, import_index_12fa369c.j)("name", name, 0)}${(0, import_index_12fa369c.j)("value", value, 0)} ${required ? "required" : ""}${(0, import_index_12fa369c.j)("min", min, 0)}${(0, import_index_12fa369c.j)("max", max, 0)}${(0, import_index_12fa369c.j)("step", step, 0)}${(0, import_index_12fa369c.k)("bx--slider__input".trim())}></div>
    <span${(0, import_index_12fa369c.k)("bx--slider__range-label".trim())}>${(0, import_index_12fa369c.h)(maxLabel || max)}</span>
    <input${(0, import_index_12fa369c.j)("type", hideTextInput ? "hidden" : inputType, 0)}${(0, import_index_12fa369c.j)("style", hideTextInput ? "display: none" : void 0, 0)} id="${"input-" + (0, import_index_12fa369c.h)(id)}"${(0, import_index_12fa369c.j)("name", name, 0)}${(0, import_index_12fa369c.j)("value", value, 0)}${(0, import_index_12fa369c.j)("aria-labelledby", $$props["aria-label"] ? void 0 : labelId, 0)}${(0, import_index_12fa369c.j)("aria-label", $$props["aria-label"] || "Slider number input", 0)} ${disabled ? "disabled" : ""} ${required ? "required" : ""}${(0, import_index_12fa369c.j)("min", min, 0)}${(0, import_index_12fa369c.j)("max", max, 0)}${(0, import_index_12fa369c.j)("step", step, 0)}${(0, import_index_12fa369c.j)("data-invalid", invalid || null, 0)}${(0, import_index_12fa369c.j)("aria-invalid", invalid || null, 0)}${(0, import_index_12fa369c.k)(("bx--text-input bx--slider-text-input " + (light ? "bx--text-input--light" : "") + " " + (invalid ? "bx--text-input--invalid" : "")).trim())}></div></div>`;
});
...
const Draw = (0, import_index_12fa369c.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_mapobject = (0, import_index_12fa369c.o)(import_mapstore.mapobject, (value) => value);
  $$unsubscribe_selected = (0, import_index_12fa369c.o)(import_mapstore.selected, (value) => $selected = value);
  $$unsubscribe_mapfunctions = (0, import_index_12fa369c.o)(import_mapstore.mapfunctions, (value) => value);
  $$unsubscribe_maplayer = (0, import_index_12fa369c.o)(import_mapstore.maplayer, (value) => value);
  $$unsubscribe_mapsource = (0, import_index_12fa369c.o)(import_mapstore.mapsource, (value) => value);
  $$unsubscribe_draw_enabled = (0, import_index_12fa369c.o)(import_mapstore.draw_enabled, (value) => $draw_enabled = value);
  $$unsubscribe_draw_type = (0, import_index_12fa369c.o)(import_mapstore.draw_type, (value) => $draw_type = value);
  $$unsubscribe_radiusInKm = (0, import_index_12fa369c.o)(import_mapstore.radiusInKm, (value) => value);
  $$unsubscribe_query = (0, import_index_12fa369c.o)(import_mapstore.query, (value) => $query = value);
  let { width = "100%" } = $$props;
  ...
  $$unsubscribe_query();
  return `
<main class="${"w-screen min-h-screen flex flex-col"}"><div id="${"map"}">${(0, import_index_12fa369c.v)(import_AreaMap_svelte.default, "AreaMap").$$render($$result, { drawing_tools: true }, {}, {})}</div>
  <header class="${"svelte-10r4fzz"}">${(0, import_index_12fa369c.v)(import_Grid_5e1041d9.G, "Grid").$$render($$result, {}, {}, {
    default: () => {
      return `${(0, import_index_12fa369c.v)(import_Column_5653abb6.R, "Row").$$render($$result, { id: "head1" }, {}, {
        default: () => {
        ...
        ${(0, import_index_12fa369c.v)(import_Column_5653abb6.C, "Column").$$render($$result, { style: "float:right;margin-right:2px" }, {}, {
            default: () => {
              return `${(0, import_index_12fa369c.v)(Breadcrumb, "Breadcrumb").$$render($$result, {}, {}, {
                default: () => {
                  return `${(0, import_index_12fa369c.v)(BreadcrumbItem, "BreadcrumbItem").$$render($$result, { href: "/draw" }, {}, {
                    default: () => {
                      return `Draw Area`;
                    }
                  })}
            ${(0, import_index_12fa369c.v)(BreadcrumbItem, "BreadcrumbItem").$$render($$result, { href: "/" }, {}, {
                    default: () => {
      ...
      ${(0, import_index_12fa369c.v)(import_Column_5653abb6.R, "Row").$$render($$result, { id: "head2" }, {}, {
        default: () => {
          return `
        ${(0, import_index_12fa369c.v)(import_Column_5653abb6.C, "Column").$$render($$result, {}, {}, {
            default: () => {
              return `${(0, import_index_12fa369c.v)(import_DrawButtons_svelte.default, "DrawButtons").$$render($$result, {}, {}, {})}`;
            }
          })}${(0, import_index_12fa369c.v)(import_Column_5653abb6.C, "Column").$$render($$result, {}, {}, {
            default: () => {
              return `${(0, import_index_12fa369c.v)(import_EditButtons_svelte.default, "EditButtons").$$render($$result, {}, {}, {})}`;
            }
          })}${(0, import_index_12fa369c.v)(import_Column_5653abb6.C, "Column").$$render($$result, {}, {}, {
            default: () => {
              return `${(0, import_index_12fa369c.v)(import_PostcodeSearch_fa081eca.P, "PostcodeSearch").$$render($$result, {}, {}, {})}
          
          ${(0, import_index_12fa369c.v)(import_ProgressButtons_svelte.default, "ProgressButtons").$$render($$result, {}, {}, {})}`;
            }
          })}`;
        }
      })}`;
    ...
    ${(0, import_index_12fa369c.v)(import_InfoBox_svelte.default, "InfoBox").$$render($$result, { open: $selected.length < 2 }, {}, {
    default: () => {
      return `${$draw_enabled ? `${(0, import_index_12fa369c.v)(ToastNotification, "ToastNotification").$$render($$result, {
        style: "width:100%",
        ...
        caption: ""
      }, {}, {})}` : `${$draw_type === "radius" ? `${(0, import_index_12fa369c.v)(import_ItemAccordion_svelte.default, "ItemAccordion").$$render($$result, {
        title: "Draw Area",
        subtitle: "Distance Selection Tool"
      }, {}, {
        default: () => {
          return `${(0, import_index_12fa369c.v)(Slider, "Slider").$$render($$result, {
      ...
      })}` : `${$draw_type === "click" ? `${(0, import_index_12fa369c.v)(import_ItemAccordion_svelte.default, "ItemAccordion").$$render($$result, {
        title: "Draw Area",
      ...
      })}` : `${$draw_type === "poly" ? `${(0, import_index_12fa369c.v)(import_ItemAccordion_svelte.default, "ItemAccordion").$$render($$result, {
        title: "Draw Area",
      ...
      ${function(__value) {
        if ((0, import_index_12fa369c.t)(__value)) {
          __value.then(null, import_index_12fa369c.n);
          return ``;
        }
        return function(value) {
          return `
        ${value.error != null ? `${(0, import_index_12fa369c.v)(ToastNotification, "ToastNotification").$$render($$result, {
            style: "width:100%",
            hideCloseButton: true,
            kind: "error",
            subtitle: value.error_title,
            caption: value.error
          }, {}, {})}` : `${value.oa ? `${(0, import_index_12fa369c.v)(import_ItemAccordion_svelte.default, "ItemAccordion").$$render($$result, {
            title: "",
            subtitle: "Compressed Selection"
          }, {}, {
            default: () => {
              return `<small><b>MSOA: </b> <span>${(0, import_index_12fa369c.h)(value.properties.msoa.length)}</span> <br>
              <b>LSOA: </b> <span>${(0, import_index_12fa369c.h)(value.properties.lsoa.length)}</span> <br>
              <b>OA: </b> <span>${(0, import_index_12fa369c.h)(value.properties.oa.length)}</span> <br>
              parent tile: ${(0, import_index_12fa369c.h)(value.properties.tile)}; # original output areas ${(0, import_index_12fa369c.h)(value.properties.original)}</small>`;
            }
          })}` : ``}`}
      `;
        }(__value);
