...
var import_Grid_6d898cfb = require("../../../chunks/Grid-6d898cfb.js");
...
const NotificationButton = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  let $$restProps = (0, import_index_f909a211.j)($$props, ["notificationType", "icon", "title", "iconDescription"]);
  let { notificationType = "toast" } = $$props;
  let { icon = import_PostcodeSearch_760d5c5a.C } = $$props;
  ...
  return `
<button${(0, import_index_f909a211.k)([
    { type: "button" },
    {
      "aria-label": (0, import_index_f909a211.l)(iconDescription)
    },
    {
      title: (0, import_index_f909a211.l)(iconDescription)
    },
  ...
  })}>${(0, import_index_f909a211.v)(icon || import_index_f909a211.m, "svelte:component").$$render($$result, {
    title,
    class: "bx--" + notificationType + "-notification__close-icon"
  }, {}, {})}</button>`;
});
const CheckmarkFilled20 = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const ErrorFilled20 = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const InformationFilled20 = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const InformationSquareFilled20 = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const WarningFilled20 = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const WarningAltFilled20 = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const NotificationIcon = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.iconDescription === void 0 && $$bindings.iconDescription && iconDescription !== void 0)
    $$bindings.iconDescription(iconDescription);
  return `${(0, import_index_f909a211.v)(icons[kind] || import_index_f909a211.m, "svelte:component").$$render($$result, {
    title: iconDescription,
    class: "bx--" + notificationType + "-notification__icon"
  }, {}, {})}`;
});
const ToastNotification = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `
${`<div${(0, import_index_f909a211.k)([
    { role: (0, import_index_f909a211.l)(role) },
    { kind: (0, import_index_f909a211.l)(kind) },
    (0, import_index_f909a211.o)($$restProps)
  ], {
  ...
  })}>${(0, import_index_f909a211.v)(NotificationIcon, "NotificationIcon").$$render($$result, { kind }, {}, {})}
    <div${(0, import_index_f909a211.p)("bx--toast-notification__details".trim())}><h3${(0, import_index_f909a211.p)("bx--toast-notification__title".trim())}>${slots.title ? slots.title({}) : `${(0, import_index_f909a211.e)(title)}`}</h3>
      <div${(0, import_index_f909a211.p)("bx--toast-notification__subtitle".trim())}>${slots.subtitle ? slots.subtitle({}) : `${(0, import_index_f909a211.e)(subtitle)}`}</div>
      <div${(0, import_index_f909a211.p)("bx--toast-notification__caption".trim())}>${slots.caption ? slots.caption({}) : `${(0, import_index_f909a211.e)(caption)}`}</div>
      ${slots.default ? slots.default({}) : ``}</div>
    ${!hideCloseButton ? `${(0, import_index_f909a211.v)(NotificationButton, "NotificationButton").$$render($$result, { iconDescription }, {}, {})}` : ``}</div>`}`;
});
const Slider = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  let labelId;
  let range;
  let left;
  let $$restProps = (0, import_index_f909a211.j)($$props, [
  ...
  let { name = "" } = $$props;
  let { ref = null } = $$props;
  const dispatch = (0, import_index_f909a211.t)();
  let trackRef = null;
...
<div${(0, import_index_f909a211.k)([(0, import_index_f909a211.o)($$restProps)], { classes: "bx--form-item" })}><label${(0, import_index_f909a211.h)("for", id, 0)}${(0, import_index_f909a211.h)("id", labelId, 0)}${(0, import_index_f909a211.p)(("bx--label " + (disabled ? "bx--label--disabled" : "")).trim())}>${slots.labelText ? slots.labelText({}) : `
      ${(0, import_index_f909a211.e)(labelText)}
    `}</label>
  <div${(0, import_index_f909a211.p)("bx--slider-container".trim())}><span${(0, import_index_f909a211.p)("bx--slider__range-label".trim())}>${(0, import_index_f909a211.e)(minLabel || min)}</span>
    <div role="${"presentation"}" tabindex="${"-1"}"${(0, import_index_f909a211.p)(("bx--slider " + (disabled ? "bx--slider--disabled" : "")).trim())}${(0, import_index_f909a211.h)("this", ref, 0)}><div role="${"slider"}" tabindex="${"0"}" style="${"left: " + (0, import_index_f909a211.e)(left) + "%"}"${(0, import_index_f909a211.h)("aria-valuemax", max, 0)}${(0, import_index_f909a211.h)("aria-valuemin", min, 0)}${(0, import_index_f909a211.h)("aria-valuenow", value, 0)}${(0, import_index_f909a211.h)("id", id, 0)}${(0, import_index_f909a211.p)("bx--slider__thumb".trim())}></div>
      <div${(0, import_index_f909a211.p)("bx--slider__track".trim())}${(0, import_index_f909a211.h)("this", trackRef, 0)}></div>
      <div style="${"transform: translate(0, -50%) scaleX(" + (0, import_index_f909a211.e)(left / 100) + ")"}"${(0, import_index_f909a211.p)("bx--slider__filled-track".trim())}></div>
      <input type="${"hidden"}"${(0, import_index_f909a211.h)("name", name, 0)}${(0, import_index_f909a211.h)("value", value, 0)} ${required ? "required" : ""}${(0, import_index_f909a211.h)("min", min, 0)}${(0, import_index_f909a211.h)("max", max, 0)}${(0, import_index_f909a211.h)("step", step, 0)}${(0, import_index_f909a211.p)("bx--slider__input".trim())}></div>
    <span${(0, import_index_f909a211.p)("bx--slider__range-label".trim())}>${(0, import_index_f909a211.e)(maxLabel || max)}</span>
    <input${(0, import_index_f909a211.h)("type", hideTextInput ? "hidden" : inputType, 0)}${(0, import_index_f909a211.h)("style", hideTextInput ? "display: none" : void 0, 0)} id="${"input-" + (0, import_index_f909a211.e)(id)}"${(0, import_index_f909a211.h)("name", name, 0)}${(0, import_index_f909a211.h)("value", value, 0)}${(0, import_index_f909a211.h)("aria-labelledby", $$props["aria-label"] ? void 0 : labelId, 0)}${(0, import_index_f909a211.h)("aria-label", $$props["aria-label"] || "Slider number input", 0)} ${disabled ? "disabled" : ""} ${required ? "required" : ""}${(0, import_index_f909a211.h)("min", min, 0)}${(0, import_index_f909a211.h)("max", max, 0)}${(0, import_index_f909a211.h)("step", step, 0)}${(0, import_index_f909a211.h)("data-invalid", invalid || null, 0)}${(0, import_index_f909a211.h)("aria-invalid", invalid || null, 0)}${(0, import_index_f909a211.p)(("bx--text-input bx--slider-text-input " + (light ? "bx--text-input--light" : "") + " " + (invalid ? "bx--text-input--invalid" : "")).trim())}></div></div>`;
});
...
const Draw = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_mapobject = (0, import_index_f909a211.b)(import_mapstore.mapobject, (value) => value);
  $$unsubscribe_selected = (0, import_index_f909a211.b)(import_mapstore.selected, (value) => $selected = value);
  $$unsubscribe_mapfunctions = (0, import_index_f909a211.b)(import_mapstore.mapfunctions, (value) => value);
  $$unsubscribe_maplayer = (0, import_index_f909a211.b)(import_mapstore.maplayer, (value) => value);
  $$unsubscribe_mapsource = (0, import_index_f909a211.b)(import_mapstore.mapsource, (value) => value);
  $$unsubscribe_query = (0, import_index_f909a211.b)(import_mapstore.query, (value) => $query = value);
  ...
  $$unsubscribe_radiusInKm = (0, import_index_f909a211.b)(import_mapstore.radiusInKm, (value) => value);
  let { width = "100%" } = $$props;
  ...
  return `
<main class="${"w-screen min-h-screen flex flex-col"}"><div id="${"map"}">${(0, import_index_f909a211.v)(import_AreaMap_svelte.default, "AreaMap").$$render($$result, { drawing_tools: true }, {}, {})}</div>
  <header class="${"svelte-1tcczkv"}">${(0, import_index_f909a211.v)(import_Grid_6d898cfb.G, "Grid").$$render($$result, {}, {}, {
    default: () => {
      return `${(0, import_index_f909a211.v)(import_Column_c0d99b3f.R, "Row").$$render($$result, { id: "head1" }, {}, {
        default: () => {
        ...
        <div style="${"right:0;float:right;top:0;min-height:auto;position:absolute"}">${(0, import_index_f909a211.v)(import_Button_28b43d3f.B, "Button").$$render($$result, { disabled: $query.hasOwnProperty("error") }, {}, {
            default: () => {
              return `Build Profile
          `;
            }
          })}
          ${(0, import_index_f909a211.v)(import_Button_28b43d3f.B, "Button").$$render($$result, { kind: "secondary" }, {}, {
            default: () => {
      ...
      ${(0, import_index_f909a211.v)(import_Column_c0d99b3f.R, "Row").$$render($$result, { id: "head2" }, {}, {
        default: () => {
          return `
        ${(0, import_index_f909a211.v)(import_Column_c0d99b3f.C, "Column").$$render($$result, {}, {}, {
            default: () => {
              return `${(0, import_index_f909a211.v)(import_DrawButtons_svelte.default, "DrawButtons").$$render($$result, {}, {}, {})}
          ${(0, import_index_f909a211.v)(import_EditButtons_svelte.default, "EditButtons").$$render($$result, {}, {}, {})}
          
          
          ${(0, import_index_f909a211.v)(import_ProgressButtons_svelte.default, "ProgressButtons").$$render($$result, {}, {}, {})}`;
            }
          })}`;
        }
      })}`;
    ...
    ${(0, import_index_f909a211.v)(import_InfoBox_svelte.default, "InfoBox").$$render($$result, { open: $selected.length < 2 }, {}, {
    default: () => {
      return `${$draw_enabled ? `${(0, import_index_f909a211.v)(ToastNotification, "ToastNotification").$$render($$result, {
        style: "width:100%",
        ...
        caption: ""
      }, {}, {})}` : `${$draw_type === "radius" ? `${(0, import_index_f909a211.v)(import_ItemAccordion_svelte.default, "ItemAccordion").$$render($$result, {
        title: "Draw Area",
        subtitle: "Distance Selection Tool"
      }, {}, {
        default: () => {
          return `${(0, import_index_f909a211.v)(Slider, "Slider").$$render($$result, {
      ...
      })}` : `${$draw_type === "click" ? `${(0, import_index_f909a211.v)(import_ItemAccordion_svelte.default, "ItemAccordion").$$render($$result, {
        title: "Draw Area",
      ...
      })}` : `${$draw_type === "poly" ? `${(0, import_index_f909a211.v)(import_ItemAccordion_svelte.default, "ItemAccordion").$$render($$result, {
        title: "Draw Area",
      ...
      ${function(__value) {
        ...
        return function(value) {
          return `
        ${value.error != null ? `${(0, import_index_f909a211.v)(ToastNotification, "ToastNotification").$$render($$result, {
            style: "width:100%",
            hideCloseButton: true,
            kind: "error",
            subtitle: value.error_title,
            caption: value.error
          }, {}, {})}` : `${value.oa ? `${(0, import_index_f909a211.v)(import_ItemAccordion_svelte.default, "ItemAccordion").$$render($$result, {
            title: "",
            subtitle: "Compressed Selection"
          }, {}, {
            default: () => {
              return `<small><b>MSOA: </b> <span>${(0, import_index_f909a211.e)(value.properties.msoa.length)}</span> <br>
              <b>LSOA: </b> <span>${(0, import_index_f909a211.e)(value.properties.lsoa.length)}</span> <br>
              <b>OA: </b> <span>${(0, import_index_f909a211.e)(value.properties.oa.length)}</span> <br>
              parent tile: ${(0, import_index_f909a211.e)(value.properties.tile)}; # original output areas ${(0, import_index_f909a211.e)(value.properties.original)}</small>`;
            }
          })}` : ``}`}
      `;
        }(__value);
