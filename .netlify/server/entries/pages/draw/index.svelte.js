...
const NotificationButton = (0, import_index_0029e4b6.c)(($$result, $$props, $$bindings, slots) => {
  let $$restProps = (0, import_index_0029e4b6.l)($$props, ["notificationType", "icon", "title", "iconDescription"]);
  let { notificationType = "toast" } = $$props;
  let { icon = import_Close20_fbcece5d.C } = $$props;
  ...
  return `
<button${(0, import_index_0029e4b6.o)([
    { type: "button" },
    {
      "aria-label": (0, import_index_0029e4b6.p)(iconDescription)
    },
    {
      title: (0, import_index_0029e4b6.p)(iconDescription)
    },
  ...
  })}>${(0, import_index_0029e4b6.v)(icon || import_index_0029e4b6.m, "svelte:component").$$render($$result, {
    title,
    class: "bx--" + notificationType + "-notification__close-icon"
  }, {}, {})}</button>`;
});
const CheckmarkFilled20 = (0, import_index_0029e4b6.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const ErrorFilled20 = (0, import_index_0029e4b6.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const InformationFilled20 = (0, import_index_0029e4b6.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const InformationSquareFilled20 = (0, import_index_0029e4b6.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const WarningFilled20 = (0, import_index_0029e4b6.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const WarningAltFilled20 = (0, import_index_0029e4b6.c)(($$result, $$props, $$bindings, slots) => {
  let ariaLabel;
  let ariaLabelledBy;
  let labelled;
  let attributes;
...
const NotificationIcon = (0, import_index_0029e4b6.c)(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.iconDescription === void 0 && $$bindings.iconDescription && iconDescription !== void 0)
    $$bindings.iconDescription(iconDescription);
  return `${(0, import_index_0029e4b6.v)(icons[kind] || import_index_0029e4b6.m, "svelte:component").$$render($$result, {
    title: iconDescription,
    class: "bx--" + notificationType + "-notification__icon"
  }, {}, {})}`;
});
const ToastNotification = (0, import_index_0029e4b6.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `
${`<div${(0, import_index_0029e4b6.o)([
    { role: (0, import_index_0029e4b6.p)(role) },
    { kind: (0, import_index_0029e4b6.p)(kind) },
    (0, import_index_0029e4b6.q)($$restProps)
  ], {
  ...
  })}>${(0, import_index_0029e4b6.v)(NotificationIcon, "NotificationIcon").$$render($$result, { kind }, {}, {})}
    <div${(0, import_index_0029e4b6.r)("bx--toast-notification__details".trim())}><h3${(0, import_index_0029e4b6.r)("bx--toast-notification__title".trim())}>${slots.title ? slots.title({}) : `${(0, import_index_0029e4b6.f)(title)}`}</h3>
      <div${(0, import_index_0029e4b6.r)("bx--toast-notification__subtitle".trim())}>${slots.subtitle ? slots.subtitle({}) : `${(0, import_index_0029e4b6.f)(subtitle)}`}</div>
      <div${(0, import_index_0029e4b6.r)("bx--toast-notification__caption".trim())}>${slots.caption ? slots.caption({}) : `${(0, import_index_0029e4b6.f)(caption)}`}</div>
      ${slots.default ? slots.default({}) : ``}</div>
    ${!hideCloseButton ? `${(0, import_index_0029e4b6.v)(NotificationButton, "NotificationButton").$$render($$result, { iconDescription }, {}, {})}` : ``}</div>`}`;
});
const Slider = (0, import_index_0029e4b6.c)(($$result, $$props, $$bindings, slots) => {
  let labelId;
  let range;
  let left;
  let $$restProps = (0, import_index_0029e4b6.l)($$props, [
...
<div${(0, import_index_0029e4b6.o)([(0, import_index_0029e4b6.q)($$restProps)], { classes: "bx--form-item" })}><label${(0, import_index_0029e4b6.i)("for", id, 0)}${(0, import_index_0029e4b6.i)("id", labelId, 0)}${(0, import_index_0029e4b6.r)(("bx--label " + (disabled ? "bx--label--disabled" : "")).trim())}>${slots.labelText ? slots.labelText({}) : `
      ${(0, import_index_0029e4b6.f)(labelText)}
    `}</label>
  <div${(0, import_index_0029e4b6.r)("bx--slider-container".trim())}><span${(0, import_index_0029e4b6.r)("bx--slider__range-label".trim())}>${(0, import_index_0029e4b6.f)(minLabel || min)}</span>
    <div role="${"presentation"}" tabindex="${"-1"}"${(0, import_index_0029e4b6.r)(("bx--slider " + (disabled ? "bx--slider--disabled" : "")).trim())}${(0, import_index_0029e4b6.i)("this", ref, 0)}><div role="${"slider"}" tabindex="${"0"}" style="${"left: " + (0, import_index_0029e4b6.f)(left) + "%"}"${(0, import_index_0029e4b6.i)("aria-valuemax", max, 0)}${(0, import_index_0029e4b6.i)("aria-valuemin", min, 0)}${(0, import_index_0029e4b6.i)("aria-valuenow", value, 0)}${(0, import_index_0029e4b6.i)("id", id, 0)}${(0, import_index_0029e4b6.r)("bx--slider__thumb".trim())}></div>
      <div${(0, import_index_0029e4b6.r)("bx--slider__track".trim())}${(0, import_index_0029e4b6.i)("this", trackRef, 0)}></div>
      <div style="${"transform: translate(0, -50%) scaleX(" + (0, import_index_0029e4b6.f)(left / 100) + ")"}"${(0, import_index_0029e4b6.r)("bx--slider__filled-track".trim())}></div>
      <input type="${"hidden"}"${(0, import_index_0029e4b6.i)("name", name, 0)}${(0, import_index_0029e4b6.i)("value", value, 0)} ${required ? "required" : ""}${(0, import_index_0029e4b6.i)("min", min, 0)}${(0, import_index_0029e4b6.i)("max", max, 0)}${(0, import_index_0029e4b6.i)("step", step, 0)}${(0, import_index_0029e4b6.r)("bx--slider__input".trim())}></div>
    <span${(0, import_index_0029e4b6.r)("bx--slider__range-label".trim())}>${(0, import_index_0029e4b6.f)(maxLabel || max)}</span>
    <input${(0, import_index_0029e4b6.i)("type", hideTextInput ? "hidden" : inputType, 0)}${(0, import_index_0029e4b6.i)("style", hideTextInput ? "display: none" : void 0, 0)} id="${"input-" + (0, import_index_0029e4b6.f)(id)}"${(0, import_index_0029e4b6.i)("name", name, 0)}${(0, import_index_0029e4b6.i)("value", value, 0)}${(0, import_index_0029e4b6.i)("aria-labelledby", $$props["aria-label"] ? void 0 : labelId, 0)}${(0, import_index_0029e4b6.i)("aria-label", $$props["aria-label"] || "Slider number input", 0)} ${disabled ? "disabled" : ""} ${required ? "required" : ""}${(0, import_index_0029e4b6.i)("min", min, 0)}${(0, import_index_0029e4b6.i)("max", max, 0)}${(0, import_index_0029e4b6.i)("step", step, 0)}${(0, import_index_0029e4b6.i)("data-invalid", invalid || null, 0)}${(0, import_index_0029e4b6.i)("aria-invalid", invalid || null, 0)}${(0, import_index_0029e4b6.r)(("bx--text-input bx--slider-text-input " + (light ? "bx--text-input--light" : "") + " " + (invalid ? "bx--text-input--invalid" : "")).trim())}></div></div>`;
});
...
const Draw = (0, import_index_0029e4b6.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_mapobject = (0, import_index_0029e4b6.b)(import_mapstore.mapobject, (value) => value);
  $$unsubscribe_selected = (0, import_index_0029e4b6.b)(import_mapstore.selected, (value) => $selected = value);
  $$unsubscribe_mapfunctions = (0, import_index_0029e4b6.b)(import_mapstore.mapfunctions, (value) => value);
  $$unsubscribe_maplayer = (0, import_index_0029e4b6.b)(import_mapstore.maplayer, (value) => value);
  $$unsubscribe_mapsource = (0, import_index_0029e4b6.b)(import_mapstore.mapsource, (value) => value);
  $$unsubscribe_query = (0, import_index_0029e4b6.b)(import_mapstore.query, (value) => $query = value);
  $$unsubscribe_draw_enabled = (0, import_index_0029e4b6.b)(import_mapstore.draw_enabled, (value) => $draw_enabled = value);
  $$unsubscribe_draw_type = (0, import_index_0029e4b6.b)(import_mapstore.draw_type, (value) => $draw_type = value);
  $$unsubscribe_radiusInKm = (0, import_index_0029e4b6.b)(import_mapstore.radiusInKm, (value) => value);
  $$result.css.add(css);
...
<main class="${"w-screen min-h-screen flex flex-col"}"><div id="${"map"}">${(0, import_index_0029e4b6.v)(import_AreaMap_svelte.default, "AreaMap").$$render($$result, { drawing_tools: true }, {}, {})}</div>
  <drawheader>${(0, import_index_0029e4b6.v)(import_DrawButtons_svelte.default, "DrawButtons").$$render($$result, {}, {}, {})}
    ${(0, import_index_0029e4b6.v)(import_EditButtons_svelte.default, "EditButtons").$$render($$result, {}, {}, {})}

    ${(0, import_index_0029e4b6.v)(import_Button_a63d0e2e.B, "Button").$$render($$result, { disabled: $query.hasOwnProperty("error") }, {}, {
    default: () => {
  ...
  ${(0, import_index_0029e4b6.v)(import_InfoBox_svelte.default, "InfoBox").$$render($$result, { open: $selected.length < 2 }, {}, {
    default: () => {
      return `${$draw_enabled ? `${(0, import_index_0029e4b6.v)(ToastNotification, "ToastNotification").$$render($$result, {
        style: "width:100%",
        ...
        caption: ""
      }, {}, {})}` : `${$draw_type === "radius" ? `${(0, import_index_0029e4b6.v)(import_ItemAccordion_svelte.default, "ItemAccordion").$$render($$result, {
        title: "Draw Area",
        subtitle: "Distance Selection Tool"
      }, {}, {
        default: () => {
          return `${(0, import_index_0029e4b6.v)(Slider, "Slider").$$render($$result, {
      ...
      })}` : `${$draw_type === "click" ? `${(0, import_index_0029e4b6.v)(import_ItemAccordion_svelte.default, "ItemAccordion").$$render($$result, {
        title: "Draw Area",
      ...
      })}` : `${$draw_type === "poly" ? `${(0, import_index_0029e4b6.v)(import_ItemAccordion_svelte.default, "ItemAccordion").$$render($$result, {
        title: "Draw Area",
    ...
    ${function(__value) {
        ...
        return function(value) {
          return `
      ${value.error != null ? `${(0, import_index_0029e4b6.v)(ToastNotification, "ToastNotification").$$render($$result, {
            style: "width:100%",
            hideCloseButton: true,
            kind: "error",
            subtitle: value.error_title,
            caption: value.error
          }, {}, {})}` : `${value.oa ? `${(0, import_index_0029e4b6.v)(import_ItemAccordion_svelte.default, "ItemAccordion").$$render($$result, {
            title: "",
            subtitle: "Compressed Selection"
          }, {}, {
            default: () => {
              return `<small><b>MSOA: </b> <span>${(0, import_index_0029e4b6.f)(value.properties.msoa.length)}</span> <br>
            <b>LSOA: </b> <span>${(0, import_index_0029e4b6.f)(value.properties.lsoa.length)}</span> <br>
            <b>OA: </b> <span>${(0, import_index_0029e4b6.f)(value.properties.oa.length)}</span> <br>
            parent tile: ${(0, import_index_0029e4b6.f)(value.properties.tile)}; # original output areas ${(0, import_index_0029e4b6.f)(value.properties.original)}</small>`;
            }
          })}` : ``}`}
    `;
        }(__value);
