...
const Old_layout = (0, import_index_f909a211.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<main class="${"w-screen min-h-screen flex flex-col"}"><header class="${"svelte-1mbzvnp"}">${(0, import_index_f909a211.v)(import_Grid_6d898cfb.G, "Grid").$$render($$result, {}, {}, {
    default: () => {
...
${(0, import_index_f909a211.v)(import_Column_c0d99b3f.C, "Column").$$render($$result, { style: "flex-grow:0!important;" }, {}, {
            default: () => {
              return `${(0, import_index_f909a211.v)(import_Button_28b43d3f.B, "Button").$$render($$result, {
                style: "margin-left:0px",
                class: "bx--btn bx--btn--secondary bx--btn--icon-only bx--tooltip__trigger bx--tooltip--a11y bx--tooltip--bottom bx--tooltip--align-center bx--btn--sm icon"
  ...
  `;
        ...
        ${(0, import_index_f909a211.v)(import_Column_c0d99b3f.R, "Row").$$render($$result, { style: "float:inline-right" }, {}, {
        default: () => {
          return `
