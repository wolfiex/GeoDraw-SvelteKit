import { c as create_ssr_component, f as escape, j as each, i as add_attribute, s as setContext, v as validate_component, d as getContext, k as null_to_empty } from "../../../chunks/index-0029e4b6.js";
  ...
  ${validate_component(Subhead, "Subhead").$$render($$result, {}, {}, {
        default: () => {
          return `<div class="${"margin-top--2"}">${each(dataset_keys, (key) => {
            ...
            ].join(" ").trim()}">${escape(datasets[key]["Table name"])}
...
${validate_component(Content, "Content").$$render($$result, {}, {}, {
    default: () => {
      return `<iframe id="${"ifr"}" frameborder="${".8"}" class="${"svelte-1eb19zo"}"${add_attribute("this", iframe, 0)}></iframe>
