import { c as create_ssr_component, b as subscribe, k as createEventDispatcher, e as escape, h as add_attribute } from "../../../chunks/index-c9602e46.js";
import "maplibre-gl";
...
const AreaMap = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `
<main class="${"svelte-2r8wq7"}"><div class="${"mapboxgl-canvas"}" tabindex="${"0"}" aria-label="${"Map"}" id="${"mapcontainer"}" style="${"width: " + escape(width) + "; height: " + escape(height) + "; opacity:" + escape(loading ? 0.4 : 1)}"${add_attribute("this", webgl_canvas, 0)}></div>
</main>`;
});
