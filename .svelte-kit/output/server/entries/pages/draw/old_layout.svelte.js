...
/* empty css                              *//* empty css                            */import "../../../chunks/HeaderSearch.svelte_svelte_type_style_lang-c241fd09.js";
...
const Old_layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<main class="${"w-screen min-h-screen flex flex-col"}"><header class="${"svelte-1mbzvnp"}">${validate_component(Grid, "Grid").$$render($$result, {}, {}, {
    default: () => {
