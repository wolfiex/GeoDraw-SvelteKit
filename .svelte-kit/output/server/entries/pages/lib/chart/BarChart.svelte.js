import { c as create_ssr_component, i as each, e as escape, f as add_styles, k as null_to_empty } from "../../../../chunks/index-e390a0ae.js";
...
${each(data_grouped, (group) => {
    return `<div class="${"label-group svelte-1ri9pb8"}">${escape(group.label)}
      ...
      return `<span class="${"label " + escape(i == 0 ? "bold" : "sml brackets") + " svelte-1ri9pb8"}">${escape(format(d.value))}${escape(suffix)}</span>`;
    })}</div>
